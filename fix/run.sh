...
if [ "$1" = "import" ]; then
    ...
    #sudo -u renderer osm2pgsql -d gis --create --slim  -G --hstore --tag-transform-script /home/renderer/src/openstreetmap-carto/openstreetmap-carto.lua -C 2500 --number-processes 1 -S /home/renderer/src/openstreetmap-carto/openstreetmap-carto.style
    exit 0
fi
